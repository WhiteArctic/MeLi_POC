...
def diagnose_url(args: argparse.Namespace) -> None:
    ...
    output = diagnosis.as_dict() if args.verbose else diagnosis.public_dict()
...
def main() -> None:
    ...
    p.add_argument("--verbose", action="store_true", help="Print full internal diagnostic metadata")
